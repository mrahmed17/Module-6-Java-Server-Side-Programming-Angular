...
export class PayrollService {
  ...
  createPayroll(payroll: PayrollModel): Observable<PayrollModel> {
    ...
    return this.httpClient.post<PayrollModel>(this.apiUrl, payroll)
      .pipe(
  ...
  getPayrollById(id: string): Observable<PayrollModel> {
    return this.httpClient.get<PayrollModel>(`${this.apiUrl}/${id}`)
      .pipe(
        catchError(this.handleError)
      );
  }
  ...
  getAllPayrolls(): Observable<PayrollModel[]> {
    return this.httpClient.get<PayrollModel[]>(this.apiUrl)
      .pipe(
        catchError(this.handleError)
      );
  }
  ...
  updatePayroll(id: string, payroll: PayrollModel): Observable<PayrollModel> {
    ...
    return this.httpClient.put<PayrollModel>(`${this.apiUrl}/${id}`, payroll)
      .pipe(
        catchError(this.handleError)
      );
  }
  ...
  private calculateNetPay(payroll: PayrollModel): number {
    ...
    return payroll.basicSalary + totalBonuses - totalDeductions;
  }
